...
В работе используется компилятор gcc.
...
Результат этой оптимизации оказался неудачным, вернёмся к предыдущей версии программы. Также разрешим компилятору inline функции myStrncmp и таким образом получим крайнюю, на данный момент, версию программы.
